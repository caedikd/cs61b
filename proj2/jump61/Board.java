...
class Board {
    ...
    /*
        .when you get a cell with too many spots you need to
        jump, usually this is a
    ...
    /** Returns the arrray of legal red spots. */
    ArrayList<Integer> legalRed() {
        numberBlue();
        return _legalRed;
    }

    /** Return the array of legal blue spots. */
    ...
    private ArrayDeque<Integer> _location = new ArrayDeque<>();

    /** A queue of the places of legal red moves. */
    private ArrayList<Integer> _legalRed = new ArrayList<>();

    /** A queue of the places of legal blue moves. */
    private ArrayList<Integer> _legalBlue = new ArrayList<>();

    /** Help move boards into history. */
